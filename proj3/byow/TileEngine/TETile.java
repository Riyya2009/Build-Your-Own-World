...
public class TETile implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TETile copy) {
            return character == copy.character
                    && textColor.equals(copy.textColor)
                    && backgroundColor.equals(copy.backgroundColor)
                    && description.equals(copy.description);
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return character + textColor.hashCode() + backgroundColor.hashCode() + description.hashCode();
    }
